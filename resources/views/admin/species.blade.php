	    ...
	    <div class="col-md-9" style="height: 100%; text-align: center;">
            ...
            <table width="100%" border="1px solid black" id="tabela">
                ...
                @foreach ($species as $specie)
                    <tr><td><a href="{{ URL::to('admin/species/'.$specie->id.'/edit') }}">{{$specie->name}} @if($specie->active === 0) (Inativa) @endif</a></td></tr>
                @endforeach
            </table>
            <br>
            <div class="d-flex justify-content-center">{!! $species->links() !!}</div> 
	    </div>
    </div>
</div>
